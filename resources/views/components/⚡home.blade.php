            ...
            <div
                ...
                <div class="text-on-primary space-y-stack-lg">
                    <h1 class="font-headline-xl text-headline-xl leading-tight">
                        Correos corporativos para tu negocio, <span class="text-secondary-fixed">sin
                            complicaciones</span>
                    </h1>
            ...
            <div class="max-w-container-max mx-auto px-margin-mobile md:px-8">
                <div class="grid md:grid-cols-2 gap-16 items-center">
                    <div>
                        ...
                        <div class="space-y-6">
                            <div
                                class="flex items-start gap-4 bg-error-container/20 p-4 rounded-lg border border-error/10">
                    ...
                    <div class="relative">
                        <div
                            class="bg-surface-container-lowest p-8 rounded-2xl shadow-xl border border-outline-variant">

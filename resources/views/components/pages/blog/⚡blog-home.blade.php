...
<x-layouts.index>
    ...
    <section class="relative py-section-padding overflow-hidden">
        ...
        <div class="max-w-[1280px] mx-auto px-8 md:px-32 relative z-10 flex flex-col items-center text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 items-center w-full max-w-lg mb-12">
        ...
        <div class="max-w-[1280px] mx-auto px-8 md:px-32">
            <div class="flex justify-between items-end mb-12">
                <div>
                    ...
                    <p class="text-on-surface-variant">Seleccionados cuidadosamente por nuestros expertos técnicos.</p>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-8">
                    ...
                    <div class="grid md:grid-cols-2 h-full">
                        <div class="relative h-64 md:h-auto overflow-hidden">
                            <img class="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                                ...
                                src="https://lh3.googleusercontent.com/aida-public/AB6AXuD8dvZP3NTGWU6MX7zKCY-f_9Dzrzbk77FIdwBefwCtkbcrM4jeTfLJEcxPqnQCdj5wbu50RH_K8gPEeotZni2Bj2Q-ncWPF92FOF5p4rSH8SeTcZyV4ecH1KKf6vOjDb-qEQZ8JYba2Lnb_ZaNequD_ai9xMjnXr6sEDPFo_RqtR9iwz_GZ7eTAQ8UN0krfxN6L2hdsTdZZSi-otGrZJHCjH72BkNSRoCd-ui_wDzAwxAKnsxodGhyWw" />
                            <div class="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent"></div>
                        </div>
                        <div class="p-8 flex flex-col justify-center">
                            <div class="flex items-center gap-3 mb-6">
                                <span
                                    class="px-3 py-1 bg-secondary-fixed text-on-secondary-fixed-variant rounded-lg font-label-mono text-label-mono uppercase">Seguridad</span>
                                <span class="text-on-surface-variant/60 font-label-mono text-label-mono">12 de Octubre,
                                    2024</span>
                            </div>
                            <h3 class="font-headline-lg text-headline-lg mb-4 leading-tight">Cómo evitar que tus correos
                                lleguen a spam: Guía DNS Definitiva</h3>
                            <p class="text-on-surface-variant mb-8 line-clamp-3">Aprende a configurar registros SPF,
                                DKIM y DMARC correctamente para garantizar que tus correos corporativos lleguen siempre
                                a la bandeja de entrada y no a la carpeta de no deseados.</p>
                ...
                <article
                    ...
                    <div class="mb-8">
                        ...
                        <h3 class="text-2xl font-bold leading-tight mb-4">Zoho Mail vs Google Workspace: ¿Cuál elegir en
                            2024?</h3>
            ...
            <div class="lg:col-span-8">
                ...
                <div class="space-y-12">
                    <article class="group grid md:grid-cols-3 gap-8">
                        <div class="md:col-span-1 h-48 rounded-2xl overflow-hidden border border-outline-variant/30">
                            <img class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110"
                                ...
                                src="https://lh3.googleusercontent.com/aida-public/AB6AXuBp9aQbwuo3jjONEuoSSfPqwxbeliaUGH0hfdOkXL5dAEbi-pY-NZHh2Rayg_Hzxb15-xxAOaqxpbBW3d-Nm9HHOIsMtnf9k8IC7qBeS_qW7-Z8B9BhWN30oh012EVm_-D_kkSiVaV7IF3TupT8X4ddyDajrN7R5Ri1kfftwXA0ZpX1eH-yYtNrDJXlWkxLxsXxrkkKOgjR7uKe6KiFTDGXM00wz-rzBLpztvvnR5mH35A77P2a3S40EA" />
                        </div>
                    ...
                    <article class="group grid md:grid-cols-3 gap-8">
                        <div class="md:col-span-1 h-48 rounded-2xl overflow-hidden border border-outline-variant/30">
                            <img class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110"
                                data-alt="An elegant 3D glassmorphism representation of an email icon with multiple protective layers and shields. The scene is bright, set against a pristine white background with soft teal and mint accents. High-quality render style with realistic glass transparency and refractions."
                                src="https://lh3.googleusercontent.com/aida-public/AB6AXuA9UNe8ORmEBA414F1wBgqxemKnwVwwKm-jpvHXlPj1wHKrHQ2_yXwBqxAY4p5wertoq73jeSWIAKHXXNoqM7DaSG1q9HRIYPnf-qQIZJgrcAWpS8tUoWbuWpilHbw1blRXmJAlHbWna4dqzkkkFS5wYrJk3i-SRwhnFNtC1H_qI_YWRiv8q_joTbBFXl1_1STvINl4-6exStQtDYPSgLOitjmdr0kjWmjcxVTJLw9TI5YmfFVvXcMO6w" />
                        </div>
                        <div class="md:col-span-2">
                            <div class="flex gap-4 mb-3">
                                <span class="text-secondary font-bold text-sm">Zoho Mail</span>
                                <span class="text-on-surface-variant/60 text-sm">• 8 min de lectura</span>
                            </div>
                            <h3 class="text-xl font-bold mb-3 group-hover:text-secondary transition-colors">Maximizando
                                el panel de control de Zoho Mail para Administradores</h3>
                            <p class="text-on-surface-variant mb-4">Una guía técnica para gestionar usuarios, políticas
                                de retención y cuotas de almacenamiento de forma eficiente.</p>
                            <a class="text-primary font-bold text-sm flex items-center gap-1" href="#">Continuar
                                leyendo <span class="material-symbols-outlined text-sm">open_in_new</span></a>
                        </div>
                    </article>
                    <article class="group grid md:grid-cols-3 gap-8">
                        <div class="md:col-span-1 h-48 rounded-2xl overflow-hidden border border-outline-variant/30">
                            <img class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110"
                                data-alt="A clean top-down view of a modern professional workspace with a sleek laptop showing a dashboard and a smartphone. The lighting is bright and natural, creating a high-key light mode look. The color palette is composed of soft greys, pure whites, and small accents of vibrant teal."
                                src="https://lh3.googleusercontent.com/aida-public/AB6AXuBtQPKyIvnxNzmDHI9wQMqjCBIa6b1QVdOHCkRfinTKM9r2uKQymT8vujG9yvLfVJoaPEzoWdiVZXVBNYOwOFGJywGOj9ItscwQcRkLwfXaROY4vCWEQlA8YYI9Pz4I6nrorRrb6OCAPbbXyCtvtJ3PzZFKqUpSk6EzPzoyJId7OpU9lMzciZDS3EMYT-NQ6B4luAZQ4cmwHPaFbiTbSWJcg-1MIQPMi3D5xIQeX4z6Yvtr75dZPu2Fpw" />
                        </div>
                        <div class="md:col-span-2">
                            <div class="flex gap-4 mb-3">
                                <span class="text-secondary font-bold text-sm">Seguridad</span>
                                <span class="text-on-surface-variant/60 text-sm">• 10 min de lectura</span>
                            </div>
                            <h3 class="text-xl font-bold mb-3 group-hover:text-secondary transition-colors">
                                Autenticación en dos pasos: Por qué es obligatoria para tu empresa</h3>
                            <p class="text-on-surface-variant mb-4">La seguridad de tu correo es la seguridad de tu
                                negocio. Implementa 2FA y protege tus activos digitales hoy mismo.</p>
                            <a class="text-primary font-bold text-sm flex items-center gap-1" href="#">Continuar
                                leyendo <span class="material-symbols-outlined text-sm">open_in_new</span></a>
                        </div>
                    </article>
                ...
                <div class="glass-card p-8 rounded-3xl">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <a class="px-4 py-2 bg-surface-container-highest rounded-full text-sm font-medium hover:bg-secondary hover:text-on-secondary transition-all"
                            href="#">Zoho Mail</a>
                        <a class="px-4 py-2 bg-surface-container-highest rounded-full text-sm font-medium hover:bg-secondary hover:text-on-secondary transition-all"
                            href="#">Google Workspace</a>
                        <a class="px-4 py-2 bg-surface-container-highest rounded-full text-sm font-medium hover:bg-secondary hover:text-on-secondary transition-all"
                            href="#">DNS</a>
                        <a class="px-4 py-2 bg-surface-container-highest rounded-full text-sm font-medium hover:bg-secondary hover:text-on-secondary transition-all"
                            href="#">Seguridad</a>
                        <a class="px-4 py-2 bg-surface-container-highest rounded-full text-sm font-medium hover:bg-secondary hover:text-on-secondary transition-all"
                            href="#">Productividad</a>
                        <a class="px-4 py-2 bg-surface-container-highest rounded-full text-sm font-medium hover:bg-secondary hover:text-on-secondary transition-all"
                            href="#">Empresas</a>
                    </div>
                </div>
                ...
                <div class="p-8">
                    ...
                    <div class="space-y-6">
                        <a class="flex gap-4 group" href="#">
                            ...
                            <div>
                                <h4 class="font-bold text-sm leading-snug group-hover:underline">Configuración SPF y
                                    DKIM paso a paso</h4>
                                <span class="text-xs text-on-surface-variant/60">3.2k lecturas</span>
                            </div>
                        </a>
                        <a class="flex gap-4 group" href="#">
                            <span
                                class="text-3xl font-black text-outline-variant group-hover:text-secondary transition-colors">02</span>
                            <div>
                                <h4 class="font-bold text-sm leading-snug group-hover:underline">Ventajas de Zoho Mail
                                    frente a Outlook</h4>
                                <span class="text-xs text-on-surface-variant/60">2.8k lecturas</span>
                            </div>
                        </a>
                        <a class="flex gap-4 group" href="#">
                            <span
                                class="text-3xl font-black text-outline-variant group-hover:text-secondary transition-colors">03</span>
                            <div>
                                <h4 class="font-bold text-sm leading-snug group-hover:underline">Guía de backup para
                                    correos masivos</h4>
                                <span class="text-xs text-on-surface-variant/60">1.5k lecturas</span>
                            </div>
                        </a>
                    </div>
                </div>
    ...
    <section class="max-w-[1280px] mx-auto px-8 md:px-32 mb-section-padding">
        <div
            ...
            <div class="relative z-10 md:max-w-xl">
                ...
                <p class="text-on-mint-container/80 text-lg mb-8">Nuestros técnicos certificados en Zoho y Google están
            ...
            <div class="relative z-10 w-full md:w-1/3">
                <div class="glass-card p-6 rounded-3xl border-secondary/20 shadow-2xl">
                    ...
                    <p class="text-sm text-on-mint-container/80 italic">"Resolvieron mi problema con los registros DNS
